...
to_do = { 
           'grandprixhardcore' => 'http://www.grandprix.com/ft/rss.xml',
             ...
             'winespec' => 'http://www.winespectator.com/RSS/headlines_rss/0,3991,,00.xml'
...
puts "Result is #{feed_messages.join("\n")}"
  email='scott.sproule@cure.com.ph'
                    ...
                    email='scott.sproule@cure.com.ph'
                    StompMessage::StompSendTopic.send_email_stomp("scott.sproule@cure.com.ph","WEEKLY RSS", email,
