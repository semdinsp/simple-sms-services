...
# daily_sms_routines.rb  -h svbalance.cure.com.ph
# == Author
...
feed_messages=[]
  email='scott.sproule@cure.com.ph'
                  ...
                  puts "Result is #{feed_messages.join("\n")}"
                    email='scott.sproule@cure.com.ph'
                    StompMessage::StompSendTopic.send_email_stomp("scott.sproule@cure.com.ph","DAILY IMAGE MMS", email,
                                    "flickr tags: processed  #{feed_messages.size}", feed_messages.join('\n'))
